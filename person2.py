...
###configure reciver
Vidrecv = StreamingServer(local_ip_address, 7070)
Audrecv = AudioReceiver(local_ip_address, 7777)
...
def Audbtn():
    ...
    if(chkIp(target_ip)):
        try:
            startAudio(target_ip=target_ip);
